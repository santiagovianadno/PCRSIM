...
Simulación interactiva del proceso de PCR usando células termófilas
"""
...
class ThermophilicCell :
    """Representación de una célula termófila"""
    ...
    def update (self ,dt :float ,pcr_stage :str ,hand_position :Optional [Tuple [float ,float ,float ]]=None ):
        """Actualiza el estado de la célula basado en la etapa de PCR"""
        ...
        if hand_position :
            hand_x ,hand_y ,hand_z =hand_position
            distance =math .sqrt ((self .x -hand_x )**2 +(self .y -hand_y )**2 +(self .z -hand_z )**2 )
            ...
            if distance <2.0 :
                ...
                influence =max (0 ,1.0 -distance /2.0 )
                self .x +=(hand_x -self .x )*influence *dt *0.5
                self .y +=(hand_y -self .y )*influence *dt *0.5
                self .z +=(hand_z -self .z )*influence *dt *0.5
...
class PCRSimulation :
    """Simulación principal del proceso de PCR"""
    ...
    def __init__ (self ,width :int =1280 ,height :int =720 ):
        ...
        pygame .display .set_caption ("PCR Termophilic Cells Interactive")
        ...
        self .cells :List [ThermophilicCell ]=[]
    ...
    def generate_cells (self ,count :int ):
        ...
        for _ in range (count ):
            ...
            self .cells .append (ThermophilicCell (x ,y ,z ))

    def load_ply_model (self ,filename :str ):
        """Carga un modelo PLY para representar las células"""
        try :
    ...
    def process_hand_tracking (self ):
        """Procesa el tracking de manos con MediaPipe"""
    ...
    def update (self ,dt :float ):
        ...
        for cell in self .cells :
            ...
            cell .update (dt ,self .current_stage ,hand_pos )
